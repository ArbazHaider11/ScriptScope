# ScriptScope
A high-performance RAG-based AI Script Doctor that analyzes screenplays for pacing, subtext, and 'on-the-nose' dialogue using Gemini 2.5 Flash and Pinecone.
...
**⚡ Powered by:**
* **LLM:** Google Gemini 1.5 Flash (Fast & Smart)
